...
import com.polohach.geofence.example.network.error.ServerError
import com.polohach.geofence.example.network.exceptions.ApiException
import com.polohach.geofence.example.network.exceptions.NoNetworkException
import com.polohach.geofence.example.network.exceptions.ServerException
import com.polohach.geofence.example.network.exceptions.ValidationError
...
object NetworkErrorUtils {
    ...
    private fun parseErrorResponseBody(response: Response<*>): Exception {
        ...
        try {
            ...
            try {
                serverError = NetworkModule
                        .mapper
                        .readValue(sb.toString(), ServerError::class.java)
            } catch (e: IOException) {
